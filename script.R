...
# Paralelizar 
cl <- makePSOCKcluster(4, outfile="")
registerDoParallel(cl)

# Leitura dados de treino
# "../input/competicao-dsa-machine-learning-dec-2019/dataset_treino.csv"
...
# models_tunning <- 
#   resamples(list(model_xgb_tune = model_xgb_tune,
#                  model_xgb_tune2 = model_xgb_tune2,
#                  model_xgb_tune3 = model_xgb_tune3,
#                  model_xgb_tune4 = model_xgb_tune4,
#                  model_xgb_tune5 = model_xgb_tune5,
#                  model_xgb_final = model_xgb_final))
# 
# bwplot(models_tunning)

# saveRDS(model_xgb_final, "model_xgb_final.rds")

# Test sub ------------------------------------------------------------------------------------
rm(list=setdiff(ls(), "model_xgb_final"))
# "../input/competicao-dsa-machine-learning-dec-2019/dataset_teste.csv"
